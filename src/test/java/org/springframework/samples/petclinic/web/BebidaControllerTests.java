...
//carta oferta pedido bebida
    ...
    void testInitCreationForm() throws Exception {
		mockMvc.perform(get("/cartas/{cartaId}/cartas/new", TEST_CARTA_ID)).andExpect(status().isOk())
			.andExpect(view().name("cartas/createOrUpdateCartaForm")).andExpect(model().attributeExists("carta"));
		...
		mockMvc.perform(get("/ofertas/{ofertaId}/ofertas/new", TEST_PEDIDO_ID)).andExpect(status().isOk())
    ...
    void testProcessCreationFormSuccess() throws Exception {
		mockMvc.perform(post("/cartas/{cartaId}/cartas/new", TEST_CARTA_ID)
							.with(csrf())
							.param("contador","1")
		...
		mockMvc.perform(post("/pedidos/{pedidoId}/pedidos/new", TEST_PEDIDO_ID)
							.with(csrf())
							.param("contador","1")
							.param("nombre","Hidromiel")
							.param("coste","10")
		...
		mockMvc.perform(post("/ofertas/{ofertaId}/ofertas/new", TEST_OFERTA_ID)
							.with(csrf())
							.param("contador","1")
							.param("nombre","Hidromiel")
							.param("coste","10")
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc.perform(post("/ofertas/{cartaId}/bebidas/{bebidaId}/edit", TEST_CARTA_ID, TEST_BEBIDA_ID)
							.with(csrf())
							.param("contador","1")
							.param("nombre","Hidromiel")
							.param("coste","10")
	...
	void testInitUpdateForm() throws Exception {
		mockMvc.perform(get("/cartas/{cartaId}/bebidas/{bebidaId}/edit", TEST_CARTA_ID, TEST_BEBIDA_ID))
	...
	void testProcessUpdateFormSuccess() throws Exception {
		mockMvc.perform(post("/cartas/{cartaId}/bebidas/{bebidaId}/edit", TEST_CARTA_ID, TEST_BEBIDA_ID)
				.with(csrf())
				.param("contador","1")
				.param("nombre","Hidromiel")
				.param("coste","10")
	...
	@WithMockUser(value = "spring")
		...
		void testShowBebidasListXml() throws Exception {
			mockMvc.perform(get("/bebidas.xml").accept(MediaType.APPLICATION_XML)).andExpect(status().isOk())
